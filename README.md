...
- **[n8n-nodes-faktoapp-wfirma](packages/n8n-nodes-wfirma)** — wFirma accounting integration (42 tools, 10 resources)
- **[n8n-nodes-faktoapp-fakturownia](packages/n8n-nodes-fakturownia)** — Fakturownia invoicing integration (37 tools, 5 resources)
...
- Tag `wfirma-v*` triggers publish of n8n-nodes-faktoapp-wfirma
- Tag `fakturownia-v*` triggers publish of n8n-nodes-faktoapp-fakturownia
